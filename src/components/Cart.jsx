...
import { selectCartItems, selectCartState,selectTotalQTY, selectTotalAmount, setClearCartItem, setCloseCart, setGetTotals } from '../app/CartSlice.js'
...
useEffect(()=>{
  ...
  return (
    <>
      <div className={` fixed top-0 left-0 right-0 bottom-0 blur-effect-theme w-full h-screen z-[250] opacity-100 ${ifCartState ? "opacity-100 visible translate-x-0" : "opacity-0 invisible translate-x-0 "}`}>
